// This code is initially copied from https://beta.solpg.io/github.com/solana-developers/anchor-transfer-hook/tree/counter
    ...
    pub fn initialize_extra_account_meta_list(
        ...
        let account_metas = vec![
            ExtraAccountMeta::new_with_seeds(
                &[
                    Seed::Literal {bytes: "counter".as_bytes().to_vec()},
